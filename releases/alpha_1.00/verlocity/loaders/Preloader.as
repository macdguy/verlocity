 ...
 * ---------------------------------------------------------------
 * Description:
 * 		Handles the preloading of the game and its assets.
 * ---------------------------------------------------------------
*/
package verlocity.loaders 
{
	...
	{
		[Embed(source = "../VerlocityContent.swf", symbol = "LoadingWheel")]
		private var VerlocityLoadingWheel:Class;
		...
		*/
		...
		/**
		 * Checks if the preloading is finished.
		 * @param	e Enter frame tick.
		 */
