...
package verlocity.display.ui
{
	...
	public class Scroll extends UIElement
	{
		...
		private var uiContent:UIElement;
		private var uiScrollBar:UIElement;
		private var uiScrollBarArea:UIElement;
		...
		private var _sStage:Stage;

		public function Scroll( sStage:Stage ):void
		{
			_sStage = sStage;

			uiContent = new UIElement();
			addChild( uiContent );
		...
		public override function Dispose():void
		{
			...
			_sStage.removeEventListener( MouseEvent.MOUSE_UP, OnUp );
